...
import {
  ...
  LogOut, Search, ShoppingBag, CheckCircle2,
} from 'lucide-react';
import './page.css';
      ...
      <main className="main-content">
        <div className="topbar">
          <div className="topbar-text">
            ...
            <h1 className="title">{user.name || 'Luxury Member'} ✨</h1>
            <p className="subtitle">Manage your luxury experience.</p>
          </div>
        ...
        {successMsg && (
          <div style={{
            background: '#edf5e8', padding: '14px 20px',
            borderRadius: 10, marginBottom: '20px',
          }}>
        ...
        {activeMenu === 'orders' && (
          <div className="card">
            <h2 className="card-heading">MY ORDERS</h2>
            {orders.length === 0 ? (
              <p>No orders yet</p>
            ) : (
              orders.map((order: any, i: number) => (
                <div key={i}>{order.name}</div>
              ))
            )}
          </div>
        )}
        ...
        {activeMenu === 'wishlist' && (
          <div className="card">
            <h2 className="card-heading">MY WISHLIST</h2>
            {wishlist.length === 0 ? (
